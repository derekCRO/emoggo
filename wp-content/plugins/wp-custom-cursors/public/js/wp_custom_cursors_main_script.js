    ...
    window.addEventListener("load", function (event) {
      ...
      const getMousePosition = function (e) {
        ...
        if (el1VelocityResizeFlag || el2VelocityResizeFlag) {
          distanceX = Math.sqrt(
            Math.pow(e.clientX - mouseData.prevX, 2) +
              Math.pow(e.clientY - mouseData.prevY, 2)
          );
          timeDiff = e.timeStamp - mouseData.prevTimeStamp;
          velX = distanceX / timeDiff;
          velX = 1 / (1 + velX);
      ...
      function createCursor(element, cursor) {
        ...
        [...created_cursors].forEach(function (createdCursor) {
          if (createdCursor.cursor_id == createdCursorId) {
            ...
            switch (createdCursor.cursor_type) {
              case "shape":
                cursorWrapper.style.setProperty(
                  "--fe-width",
                  createdCursor.cursor_options.fe_width + "px"
                );
                cursorWrapper.style.setProperty(
                  "--fe-height",
                  createdCursor.cursor_options.fe_height + "px"
                );
                cursorWrapper.style.setProperty(
                  "--fe-color",
                  createdCursor.cursor_options.fe_color
                );
                cursorWrapper.style.setProperty(
                  "--fe-border-width",
                  createdCursor.cursor_options.fe_border_width + "px"
                );
                cursorWrapper.style.setProperty(
                  "--fe-border-radius",
                  createdCursor.cursor_options.fe_radius + "px"
                );
                cursorWrapper.style.setProperty(
                  "--fe-border-color",
                  createdCursor.cursor_options.fe_border_color
                );
                cursorWrapper.style.setProperty(
                  "--fe-transition-duration",
                  createdCursor.cursor_options.fe_duration + "ms"
                );
                cursorWrapper.style.setProperty(
                  "--fe-transition-timing",
                  createdCursor.cursor_options.fe_timing
                );
                cursorWrapper.style.setProperty(
                  "--fe-blending-mode",
                  createdCursor.cursor_options.fe_blending
                );
                cursorWrapper.style.setProperty(
                  "--fe-zindex",
                  createdCursor.cursor_options.fe_zindex
                );
                cursorWrapper.style.setProperty(
                  "--fe-backdrop",
                  `${createdCursor.cursor_options.fe_backdrop}(${createdCursor.cursor_options.fe_backdrop_value})`
                );
                ...
                cursorWrapper.style.setProperty(
                  "--se-width",
                  createdCursor.cursor_options.se_width + "px"
                );
                cursorWrapper.style.setProperty(
                  "--se-height",
                  createdCursor.cursor_options.se_height + "px"
                );
                cursorWrapper.style.setProperty(
                  "--se-color",
                  createdCursor.cursor_options.se_color
                );
                cursorWrapper.style.setProperty(
                  "--se-border-width",
                  createdCursor.cursor_options.se_border_width + "px"
                );
                cursorWrapper.style.setProperty(
                  "--se-border-radius",
                  createdCursor.cursor_options.se_radius + "px"
                );
                cursorWrapper.style.setProperty(
                  "--se-border-color",
                  createdCursor.cursor_options.se_border_color
                );
                cursorWrapper.style.setProperty(
                  "--se-transition-duration",
                  createdCursor.cursor_options.se_duration + "ms"
                );
                cursorWrapper.style.setProperty(
                  "--se-transition-timing",
                  createdCursor.cursor_options.se_timing
                );
                cursorWrapper.style.setProperty(
                  "--se-blending-mode",
                  createdCursor.cursor_options.se_blending
                );
                cursorWrapper.style.setProperty(
                  "--se-zindex",
                  createdCursor.cursor_options.se_zindex
                );
                cursorWrapper.style.setProperty(
                  "--se-backdrop",
                  `${createdCursor.cursor_options.se_backdrop}(${createdCursor.cursor_options.se_backdrop_value})`
                );
              ...
              case "image":
                ...
                imageCursor.setAttribute(
                  "src",
                  createdCursor.cursor_options.image_url
                );
                cursorEl1.appendChild(imageCursor);
                cursorWrapper.classList.add("cursor-image");

                let clickPointOption =
                    createdCursor.cursor_options.click_point.split(","),
                  clickPointX =
                    (Number(clickPointOption[0]) *
                      Number(createdCursor.cursor_options.width)) /
                    100,
                  clickPointY =
                    (Number(clickPointOption[1]) *
                      Number(createdCursor.cursor_options.height)) /
                    100;

                cursorWrapper.style.setProperty(
                  "--width",
                  createdCursor.cursor_options.width + "px"
                );
                cursorWrapper.style.setProperty(
                  "--color",
                  createdCursor.cursor_options.color
                );
                cursorWrapper.style.setProperty(
                  "--radius",
                  createdCursor.cursor_options.radius + "px"
                );
                if (createdCursor.cursor_options.background != "off") {
                  cursorWrapper.style.setProperty(
                    "--padding",
                    createdCursor.cursor_options.padding + "px"
                  );
                ...
                cursorWrapper.style.setProperty(
                  "--blending",
                  createdCursor.cursor_options.blending
                );
                break;
              case "text":
                if (
                  createdCursor.cursor_options.normal_text_type == "horizontal"
                ) {
                  ...
                  cursorEl1.firstChild.style.setProperty(
                    "--hr-width",
                    createdCursor.cursor_options.hr_width + "px"
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--hr-transform",
                    createdCursor.cursor_options.hr_transform
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--hr-size",
                    createdCursor.cursor_options.hr_size + "px"
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--hr-weight",
                    createdCursor.cursor_options.hr_weight
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--bg-color",
                    createdCursor.cursor_options.hr_bgcolor
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--hr-size",
                    createdCursor.cursor_options.hr_size + "px"
                  ...
                  cursorEl1.firstChild.style.setProperty(
                    "--hr-spacing",
                    createdCursor.cursor_options.hr_spacing + "px"
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--hr-radius",
                    createdCursor.cursor_options.hr_radius + "px"
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--hr-padding",
                    createdCursor.cursor_options.hr_padding + "px"
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--hr-backdrop",
                    createdCursor.cursor_options.hr_backdrop +
                      "(" +
                      createdCursor.cursor_options.hr_backdrop_amount +
                      ")"
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--hr-color",
                    createdCursor.cursor_options.hr_color
                  );
                  cursorWrapper.style.setProperty(
                    "--duration",
                    createdCursor.cursor_options.hr_duration + "ms"
                  );
                  cursorWrapper.style.setProperty(
                    "--timing",
                    createdCursor.cursor_options.hr_timing
                  );
                } else {
                  ...
                  cursorEl1.firstChild.style.setProperty(
                    "--dot-fill",
                    createdCursor.cursor_options.dot_color
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--text-width",
                    createdCursor.cursor_options.width + "px"
                  ...
                  cursorEl1.firstChild.style.setProperty(
                    "--text-transform",
                    createdCursor.cursor_options.text_transform
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--font-weight",
                    createdCursor.cursor_options.font_weight
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--text-color",
                    createdCursor.cursor_options.text_color
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--font-size",
                    createdCursor.cursor_options.font_size + "px"
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--word-spacing",
                    createdCursor.cursor_options.word_spacing + "px"
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--animation-name",
                    createdCursor.cursor_options.animation
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--animation-duration",
                    createdCursor.cursor_options.animation_duration + "s"
                  );
                  cursorEl1.firstChild.style.setProperty(
                    "--dot-width",
                    createdCursor.cursor_options.dot_width + "px"
                  );
                }
                break;
            }
            ...
            if (createdCursor.hover_cursors) {
              createdCursor.hover_cursors.forEach(function (hoverCursor) {
                switch (hoverCursor.hover_type) {
                  ...
                  case "snap":
                    let snapSelector = [];
                    if (hoverCursor.buttons == "on") {
                      snapSelector.push("button");
                    }
                    if (hoverCursor.images == "on") {
                      snapSelector.push("img");
                    }
                    if (hoverCursor.links == "on") {
                      snapSelector.push("a");
                    }
                    if (hoverCursor.custom == "on") {
                      snapSelector.push(hoverCursor.selector);
                    }
                    ...
                    snapSelector.forEach(function (hoverSelector) {
                      ...
                      [...hoverElements].forEach(function (el) {
                        el.addEventListener("mouseenter", function () {
                          ...
                          currentType =
                            cursorWrapper.getAttribute("data-cursor-type");
                          cursorWrapper.classList.remove(
                            `cursor-${currentType}`
                          );
                          currentChild = cursorEl1.firstChild
                            ? cursorEl1.removeChild(cursorEl1.firstChild)
                            : null;
                          ...
                          hoverElementWidth =
                            elementPos.width + hoverCursor.padding * 2;
                          hoverElementHeight =
                            elementPos.height + hoverCursor.padding * 2;
                          cursorWrapper.style.setProperty(
                            "--width",
                            hoverElementWidth + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--height",
                            hoverElementHeight + "px"
                          );

                          cursorWrapper.style.setProperty(
                            "--blending",
                            hoverCursor.blending
                          );
                          cursorWrapper.style.setProperty(
                            "--bgcolor",
                            hoverCursor.bgcolor
                          ...
                          cursorWrapper.style.setProperty(
                            "--border-color",
                            hoverCursor.border_color
                          );
                          cursorWrapper.style.setProperty(
                            "--border-width",
                            hoverCursor.border_width + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--radius",
                            hoverCursor.radius + "px"
                          );
                        ...
                        el.addEventListener("mouseleave", function () {
                          ...
                          if (currentChild) {
                            cursorEl1.appendChild(currentChild);
                          }
                  ...
                  case "shape":
                    ...
                    if (hoverCursor.custom == "on") {
                      selector.push(hoverCursor.selector);
                    }
                    ...
                    selector.forEach(function (hoverSelector) {
                      ...
                      [...hoverElements].forEach(function (el) {
                        ...
                        el.addEventListener("mouseenter", function () {
                          ...
                          cursorWrapper.classList.add(
                            `cursor-${cursor.cursor_shape}`
                          );

                          cursorWrapper.style.setProperty(
                            "--fe-width",
                            hoverCursor.hover_fe_width + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--fe-height",
                            hoverCursor.hover_fe_height + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--fe-color",
                            hoverCursor.hover_fe_color
                          );
                          cursorWrapper.style.setProperty(
                            "--fe-border-width",
                            hoverCursor.hover_fe_border_width + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--fe-border-radius",
                            hoverCursor.hover_fe_radius + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--fe-border-color",
                            hoverCursor.hover_fe_border_color
                          );
                          cursorWrapper.style.setProperty(
                            "--fe-transition-duration",
                            hoverCursor.hover_fe_duration + "ms"
                          );
                          cursorWrapper.style.setProperty(
                            "--fe-transition-timing",
                            hoverCursor.hover_fe_timing
                          );
                          cursorWrapper.style.setProperty(
                            "--fe-blending-mode",
                            hoverCursor.hover_fe_blending
                          );
                          cursorWrapper.style.setProperty(
                            "--fe-zindex",
                            hoverCursor.hover_fe_zindex
                          );
                          cursorWrapper.style.setProperty(
                            "--fe-backdrop",
                            `${hoverCursor.hover_fe_backdrop}(${hoverCursor.hover_fe_backdrop_value})`
                          );

                          cursorWrapper.style.setProperty(
                            "--se-width",
                            hoverCursor.hover_se_width + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--se-height",
                            hoverCursor.hover_se_height + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--se-color",
                            hoverCursor.hover_se_color
                          );
                          cursorWrapper.style.setProperty(
                            "--se-border-width",
                            hoverCursor.hover_se_border_width + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--se-border-radius",
                            hoverCursor.hover_se_radius + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--se-border-color",
                            hoverCursor.hover_se_border_color
                          );
                          cursorWrapper.style.setProperty(
                            "--se-transition-duration",
                            hoverCursor.hover_se_duration + "ms"
                          );
                          cursorWrapper.style.setProperty(
                            "--se-transition-timing",
                            hoverCursor.hover_se_timing
                          );
                          cursorWrapper.style.setProperty(
                            "--se-blending-mode",
                            hoverCursor.hover_se_blending
                          );
                          cursorWrapper.style.setProperty(
                            "--se-zindex",
                            hoverCursor.hover_se_zindex
                          );
                          cursorWrapper.style.setProperty(
                            "--se-backdrop",
                            `${hoverCursor.hover_se_backdrop}(${createdCursor.cursor_options.se_backdrop_value})`
                          );
                        });
                        el.addEventListener("mouseleave", function () {
                          el1VelocityXYFlag = currentEl1VelXYFlag;
                  ...
                  case "image":
                    let imageSelector = [];
                    if (hoverCursor.buttons == "on") {
                      imageSelector.push("button");
                    }
                    if (hoverCursor.images == "on") {
                      imageSelector.push("img");
                    }
                    if (hoverCursor.links == "on") {
                      imageSelector.push("a");
                    }
                    if (hoverCursor.custom == "on") {
                      imageSelector.push(hoverCursor.selector);
                    }

                    let imageCursor = document.createElement("img");
                    imageCursor.setAttribute(
                      "src",
                      hoverCursor.hover_image_url
                    );

                    let clickPointOption =
                        hoverCursor.hover_click_point.split(","),
                      clickPointX =
                        (Number(clickPointOption[0]) *
                          Number(hoverCursor.width)) /
                        100,
                      clickPointY =
                        (Number(clickPointOption[1]) *
                          Number(hoverCursor.height)) /
                        100;
                  ...
                  case "text":
                    let textSelector = [];
                    if (hoverCursor.buttons == "on") {
                      textSelector.push("button");
                    }
                    if (hoverCursor.images == "on") {
                      textSelector.push("img");
                    }
                    if (hoverCursor.links == "on") {
                      textSelector.push("a");
                    }
                    if (hoverCursor.custom == "on") {
                      textSelector.push(hoverCursor.selector);
                    }
                    ...
                    textSelector.forEach(function (hoverSelector) {
                      ...
                      [...hoverElements].forEach(function (el) {
                        el.addEventListener("mouseenter", function () {
                          ...
                          cursorWrapper.style.setProperty(
                            "--text-transform",
                            hoverCursor.hover_text_transform
                          );
                          cursorWrapper.style.setProperty(
                            "--font-weight",
                            hoverCursor.hover_font_weight
                          );
                          cursorWrapper.style.setProperty(
                            "--text-color",
                            hoverCursor.hover_text_color
                          );
                          cursorWrapper.style.setProperty(
                            "--font-size",
                            hoverCursor.font_size + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--word-spacing",
                            hoverCursor.hover_word_spacing + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--animation-name",
                            hoverCursor.hover_animation
                          );
                          cursorWrapper.style.setProperty(
                            "--animation-duration",
                            hoverCursor.hover_animation_duration + "s"
                          );
                          cursorWrapper.style.setProperty(
                            "--dot-width",
                            hoverCursor.hover_dot_width + "px"
                          );
                        });
                        el.addEventListener("mouseleave", function () {
                          el1VelocityXYFlag = currentEl1VelXYFlag;
                  ...
                  case "horizontal":
                    ...
                    if (hoverCursor.custom == "on") {
                      hrSelector.push(hoverCursor.selector);
                    }
                    ...
                    hrSelector.forEach(function (hoverSelector) {
                      ...
                      [...hoverElements].forEach(function (el) {
                        el.addEventListener("mouseenter", function () {
                          ...
                          cursorWrapper.style.setProperty(
                            "--hr-width",
                            hoverCursor.hover_hr_width + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--hr-transform",
                            hoverCursor.hover_hr_transform
                          );
                          cursorWrapper.style.setProperty(
                            "--hr-size",
                            hoverCursor.hover_hr_size + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--hr-weight",
                            hoverCursor.hover_hr_weight
                          );
                          cursorWrapper.style.setProperty(
                            "--bg-color",
                            hoverCursor.hover_hr_bgcolor
                          );
                          cursorWrapper.style.setProperty(
                            "--hr-spacing",
                            hoverCursor.hover_hr_spacing + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--hr-radius",
                            hoverCursor.hover_hr_radius + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--hr-padding",
                            hoverCursor.hover_hr_padding + "px"
                          );
                          cursorWrapper.style.setProperty(
                            "--hr-backdrop",
                            hoverCursor.hover_hr_backdrop +
                              "(" +
                              hoverCursor.hover_hr_backdrop_amount +
                              ")"
                          );
                          cursorWrapper.style.setProperty(
                            "--hr-color",
                            hoverCursor.hover_hr_color
                          );
                          cursorWrapper.style.setProperty(
                            "--duration",
                            hoverCursor.hover_hr_duration + "ms"
                          );
                          cursorWrapper.style.setProperty(
                            "--timing",
                            hoverCursor.hover_hr_timing
                          );
                        });
                        el.addEventListener("mouseleave", function () {
                          cursorWrapper.removeAttribute("style");
        ...
        function renderCursor() {
          cursorEl1.style.transform = `matrix(${mouseData.el1ScaleX}, 0, 0, ${
            mouseData.el1ScaleY
          }, ${mouseData.hx + calcLeft}, ${mouseData.hy + calcTop})`;
          cursorEl2.style.transform = `matrix(${mouseData.el2ScaleX}, 0, 0, ${mouseData.el2ScaleY}, ${mouseData.x}, ${mouseData.y})`;

          requestAnimationFrame(renderCursor);
        }

        var innerInputs = element.querySelectorAll(
        ...
        if (cursor.exclude_class.length) {
          let excludeElements = document.querySelectorAll(
            `.${cursor.exclude_class}`
          );
                          ...
                          if (addedNode.matches(selectorItem)) {
                            switch (hover.hover_type) {
                              ...
                              case "snap":
                                ...
                                addedNode.addEventListener(
                                  ...
                                  function () {
                                    ...
                                    if (cursorWrapper.getAttribute("style")) {
                                      currentStyles =
                                        cursorWrapper.getAttribute("style");
                                      cursorWrapper.removeAttribute("style");
                                    }

                                    currentType =
                                      cursorWrapper.getAttribute(
                                        "data-cursor-type"
                                      );
                                    cursorWrapper.classList.remove(
                                      `cursor-${currentType}`
                                    ...
                                    currentChild = cursorEl1.firstChild
                                      ? cursorEl1.removeChild(
                                          cursorEl1.firstChild
                                        )
                                      : null;
                                    ...
                                    let elementPos = el.getBoundingClientRect();
                                    elementTop =
                                      elementPos.top - hoverCursor.padding;
                                    elementLeft =
                                      elementPos.left - hoverCursor.padding;
                                    hoverElementWidth =
                                      elementPos.width +
                                      hoverCursor.padding * 2;
                                    hoverElementHeight =
                                      elementPos.height +
                                      hoverCursor.padding * 2;
                                    cursorWrapper.style.setProperty(
                                ...
                                break;
                              case "shape":
                                let currentStylesShape,
                                  currentChildShape,
                                  currentTypeShape,
                                  currentCalcTopShape,
                                  currentCalcLeftShape;
                                addedNode.addEventListener(
                                  "mouseenter",
                                  function () {
                                    if (cursorWrapper.getAttribute("style")) {
                                    ...
                                    currentChildShape = cursorEl1.firstChild
                                      ? cursorEl1.removeChild(
                                          cursorEl1.firstChild
                                        )
                                      : null;
                                    ...
                                    cursorWrapper.style.setProperty(
                                      "--fe-width",
                                      hover.hover_fe_width + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--fe-height",
                                      hover.hover_fe_height + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--fe-color",
                                      hover.hover_fe_color
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--fe-border-width",
                                      hover.hover_fe_border_width + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--fe-border-radius",
                                      hover.hover_fe_radius + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--fe-border-color",
                                      hover.hover_fe_border_color
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--fe-transition-duration",
                                      hover.hover_fe_duration + "ms"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--fe-transition-timing",
                                      hover.hover_fe_timing
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--fe-blending-mode",
                                      hover.hover_fe_blending
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--fe-zindex",
                                      hover.hover_fe_zindex
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--fe-backdrop",
                                      `${hover.hover_fe_backdrop}(${hover.hover_fe_backdrop_value})`
                                    );

                                    cursorWrapper.style.setProperty(
                                      "--se-width",
                                      hover.hover_se_width + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--se-height",
                                      hover.hover_se_height + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--se-color",
                                      hover.hover_se_color
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--se-border-width",
                                      hover.hover_se_border_width + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--se-border-radius",
                                      hover.hover_se_radius + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--se-border-color",
                                      hover.hover_se_border_color
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--se-transition-duration",
                                      hover.hover_se_duration + "ms"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--se-transition-timing",
                                      hover.hover_se_timing
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--se-blending-mode",
                                      hover.hover_se_blending
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--se-zindex",
                                      hover.hover_se_zindex
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--se-backdrop",
                                      `${hover.hover_se_backdrop}(${createdCursor.cursor_options.se_backdrop_value})`
                                    );
                                  }
                                );
                                addedNode.addEventListener(
                                  ...
                                  function () {
                                    ...
                                    if (currentChildShape) {
                                      cursorEl1.appendChild(currentChildShape);
                                    }
                                  }
                                );
                                break;
                              case "image":
                                ...
                                imageCursor.setAttribute(
                                  "src",
                                  hover.hover_image_url
                                );

                                let clickPointOption =
                                    hover.hover_click_point.split(","),
                                  clickPointX =
                                    (Number(clickPointOption[0]) *
                                      Number(hover.width)) /
                                    100,
                                ...
                                let currentStylesImage,
                                  currentChildImage,
                                  currentTypeImage,
                                  currentCalcTopImage,
                                  currentCalcLeftImage;
                                addedNode.addEventListener(
                                  "mouseenter",
                                  function () {
                                    if (cursorWrapper.getAttribute("style")) {
                                    ...
                                    currentChildImage = cursorEl1.firstChild
                                      ? cursorEl1.removeChild(
                                          cursorEl1.firstChild
                                        )
                                      : null;
                                    ...
                                    calcTop =
                                      (Number(paddingTop) + clickPointY) * -1;
                                    calcLeft =
                                      (Number(paddingLeft) + clickPointX) * -1;
                                    cursorWrapper.style.setProperty(
                                      "--blending",
                                      hover.blending
                                    );
                                ...
                                addedNode.addEventListener(
                                  ...
                                  function () {
                                    ...
                                    if (currentChildImage) {
                                      cursorEl1.appendChild(currentChildImage);
                                    }
                                  }
                                );
                              ...
                              case "text":
                                ...
                                addedNode.addEventListener(
                                  ...
                                  function () {
                                    ...
                                    currentChildText = cursorEl1.firstChild
                                      ? cursorEl1.removeChild(
                                          cursorEl1.firstChild
                                        )
                                      : null;
                                    ...
                                    cursorWrapper.style.setProperty(
                                      "--text-transform",
                                      hover.hover_text_transform
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--font-weight",
                                      hover.hover_font_weight
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--text-color",
                                    ...
                                    cursorWrapper.style.setProperty(
                                      "--animation-duration",
                                      hover.hover_animation_duration + "s"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--dot-width",
                                      hover.hover_dot_width + "px"
                                    );
                                  }
                                );
                                addedNode.addEventListener(
                                  ...
                                  function () {
                                    ...
                                    if (currentChildText) {
                                      cursorEl1.appendChild(currentChildText);
                                    }
                              ...
                              case "horizontal":
                                let hrContainer = document.createElement("div");
                                let currentStylesHorizontal,
                                  currentChildHorizontal,
                                  currentTypeHorizontal,
                                  currentCalcTopHorizontal,
                                  currentCalcLeftHorizontal;
                                addedNode.addEventListener(
                                  "mouseenter",
                                  function () {
                                    if (cursorWrapper.getAttribute("style")) {
                                      currentStylesHorizontal =
                                        cursorWrapper.getAttribute("style");
                                      cursorWrapper.removeAttribute("style");
                                    }
                                    currentChildHorizontal =
                                    ...
                                    cursorWrapper.style.setProperty(
                                      "--hr-width",
                                      hover.hover_hr_width + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--hr-transform",
                                      hover.hover_hr_transform
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--hr-size",
                                      hover.hover_hr_size + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--hr-weight",
                                      hover.hover_hr_weight
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--bg-color",
                                      hover.hover_hr_bgcolor
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--hr-spacing",
                                      hover.hover_hr_spacing + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--hr-radius",
                                      hover.hover_hr_radius + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--hr-padding",
                                      hover.hover_hr_padding + "px"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--hr-backdrop",
                                      hover.hover_hr_backdrop +
                                        "(" +
                                        hover.hover_hr_backdrop_amount +
                                        ")"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--hr-color",
                                      hover.hover_hr_color
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--duration",
                                      hover.hover_hr_duration + "ms"
                                    );
                                    cursorWrapper.style.setProperty(
                                      "--timing",
                                      hover.hover_hr_timing
                                    );
                                  }
                                );
                                addedNode.addEventListener(
                                  ...
                                  function () {
                                    ...
                                    if (currentChildHorizontal) {
                                      cursorEl1.appendChild(
                                        currentChildHorizontal
                                      );
                                    }
                                  }
